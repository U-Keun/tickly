...
>
  ...
  <button
    ...
    title={i18n.t('graphView')}
  >
    <svg class="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      <circle cx="12" cy="5" r="2.5" stroke-width="2" />
      <circle cx="5" cy="18" r="2.5" stroke-width="2" />
      <circle cx="19" cy="18" r="2.5" stroke-width="2" />
      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 7.5v3M7 16.5l3.5-4M17 16.5l-3.5-4" />
    </svg>
  </button>
